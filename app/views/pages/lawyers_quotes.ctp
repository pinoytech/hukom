...
<div id="full-content">
	<div id="main">
	    ...
	    <div class="public-pages">
	        ...
	        <h1><strong>Lawyer's Quotes</strong></h1>
            <div>
              <div style="float:left; padding:0 25px 0 0;"><img src="/img/holmes_pic.jpg" width="130" height="150" border="1" align="texttop" /></div>
              <h2>&quot;Every calling is great when greatly pursued.&quot;</h2>
            ...
            <br /><br />
            <div>
            	<div style="float:left; padding:0 25px 0 0;"><img src="/img/lincoln_pic.jpg" width="130" height="150" border="1" align="texttop" /></div>
              <h2>&quot;A lawyer's time and advice are his stock in trade.&quot; </h2>
