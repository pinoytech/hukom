<?php $this->viewVars['title_for_layout'] = "Outrageous Laws" ?>
<div id="full-content">
	<div id="main">
	    ...
	    <div class="public-pages">
            ...
            <div>
              <h1><strong>OUTRAGEOUS LAWS</strong></h1>
              <div style="float:left; padding:0 25px 0 0;"><img src="/img/outrageouslaw_pic.jpg" width="130" height="196" border="1" /></div>
