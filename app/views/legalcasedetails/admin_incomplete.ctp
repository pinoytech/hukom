<div class="cases index">
	<h2><?php __('Incomplete Cases');?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id');?></th>
			<th><?php echo $this->Paginator->sort('Username', 'User.username');?></th>
			<th><?php echo $this->Paginator->sort('Legal Case ID', 'Legalcase.id');?></th>
			<th><?php echo $this->Paginator->sort('Legal Problem', 'Legalcase.legal_problem');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $Legalcasedetail['User']['username']; ?>&nbsp;</td>
		<td><?php echo $Legalcasedetail['Legalcase']['id']; ?>&nbsp;</td>
