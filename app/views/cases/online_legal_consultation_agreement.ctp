...
jQuery('document').ready(function() {
	...
	jQuery('#check_end_user').click(function() {
		if(jQuery('#accept').is(":checked")){
			window.location = "/payments/select_option/<?php echo $user_id;?>/<?php echo $case_id;?>";
			return false;
		}
...
<div id="full-content">
	<div id="main">
		...
		<?php echo $this->Session->flash(); ?>
			...
			<fieldset>
		 		<legend><?php __('Online Legal Consultation Agreement'); ?></legend>
				<?php
				...
				<p>
					I, <?php echo $user_full_name;?>, of legal, freely and voluntarily provided information to E-LAWYERS ONLINE with the intention to obtain legal advice for me or for the company/partnership I duly represents. I agree that:
				</p>
				
				<ol>
					<li>I will pay the amount of [Fee] as professional fee. This fee for online legal consultation service shall cover only the subject matter discussed herein and to no other.</li>
				...
				<p style="text-align:center;">
					I hereby <input type="checkbox" id="accept" value="accept" class="terms" style="float:none;"> ACCEPT <input type="checkbox" id="reject" class="terms" value="reject" style="float:none;"> REJECT the abovesaid terms and conditions.
					<br />
					<br />
