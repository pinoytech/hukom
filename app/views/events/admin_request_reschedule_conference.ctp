...
<div class="cases index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo date('F d, Y', strtotime($RequestReschedule['RequestReschedule']['date'])); ?>&nbsp;</td>
		<td><?php echo $RequestReschedule['RequestReschedule']['start']; ?>&nbsp;</td>
		<td><?php echo $RequestReschedule['RequestReschedule']['end']; ?>&nbsp;</td>
