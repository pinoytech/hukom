<div id="full-content">
	<div id="main">
		...
		<div class="form-title">Reschedule Conference</div>
		<div class="form-holder">
		    ...
		    <?php echo $this->Form->create('User', array('onsubmit' => 'redirect(); return false;')); ?>
				...
				<p>
					...
					if ($conference == 'video') {
					?>
					through <b><?php echo ucfirst($messenger_type);?></b> using <b><?php echo $messenger_username;?></b> as my user name
					<?php
					}
					?>
...
function redirect(){    
	...
	?>
		...
		var messenger_values = '&messenger_type=<?php echo $messenger_type;?>&messenger_username=<?php echo $messenger_username;?>';
	<?php
	}
	?>
				...
				var calendar = $('#calendar').fullCalendar({
			        ...
			        dayClick: function(date, allDay, jsEvent, view) {
			            ...
			            jQuery.ajax({
			                ...
			                data: 'case_id=<?php echo $case_id;?>&date_clicked='+$.fullCalendar.formatDate(date, "yyyy-MM-dd") + '&reschedule=1',
			                success: function(msg)
			                {      
			                    if (msg == 'locked') {
			                            ...
			                            $("#event-data-add").dialog({
			                                ...
			                                buttons: {
			                                    Ok: function(data) {
			                                        ...
			                                        input_data.push('EventCaseDetailId=' + '<?php echo $case_detail_id;?>');
													<?php
													//Assign Event Colors
													switch ($conference){
														case "video":
