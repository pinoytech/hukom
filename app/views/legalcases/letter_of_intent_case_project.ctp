<div id="full-content">
	<div id="main">
        ...
        <?php
        if($service_tip && $legal_service == 'Case/Project Retainer') {
        ?>
        <div class="form-title">Online/Offline Legal Consultation Per Case/Project </div>
