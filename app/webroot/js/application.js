    ...
    $('document').ready(function() {
        ...
        $("#PaymentModeOfPaymentForm").validate({
            ...
            submitHandler: function(form) {
                ...
                if (option_value == 'cashsense') {
                ...
                else if (option_value == 'paypal') {
                    dialog_buttons['Proceed Payment with Paypal'] = function() {
                    ...
                    dialog_buttons['Proceed Payment'] =  function() {
        ...
        function submit_to_cashsense(id, case_id, case_detail_id, cashsense_type, amount) {
            ...
            $.get(url, {}, function(data) {
                //Create DOM
                $('#cashsense_form_wrapper').append(data);
        ...
        $('.option_radio').click(function() {
            ...
            switch($(this).val())
            {
                ...
                break;
                case 'check_cash':
                    payment_instructions_tabs.tabs({ selected: 5 });
                break;
                default:
                    payment_instructions_tabs.tabs({ selected: 0 });
            }
